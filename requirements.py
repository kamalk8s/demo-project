...
if not path.exists('./demo-db/data'):
    os.mkdir('./demo-db/data')
if not path.exists('./demo-api-db/data'):
    os.mkdir('./demo-api-db/data')
...
print('Run: python3 demo-data-feeder.py after docker-compose up command run successfully.')