...
$(document).ready(function () {
  randomEntry();
  getEntries();
  let tableBody = document.getElementById("main-data");
  console.log(tableBody.offsetHeight)
  if (tableBody.offsetHeight << 600) {
    tableBody.className = 'col overflow-hidden';
  } else {
    tableBody.className = 'col overflowy-scroll';
  }
});
